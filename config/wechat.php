...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID', 'wxd26f4e2b290a4d68'),         // AppID
    'secret'  => env('WECHAT_SECRET', 'd3bb43732cbe9bc259c71887667dd85a'),     // AppSecret
    'token'   => env('WECHAT_TOKEN', 'weixin'),          // Token
    'aes_key' => env('WECHAT_AES_KEY', 'RIjvntvtaU7Agmn0LIfZMFKVllwEdDisvHnY3GZP0es'),                    // EncodingAESKey
