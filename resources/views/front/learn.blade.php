            ...
            <div class="wz">
              ...
              <dl>
                <dt><img src="{{asset('public/images/s3.jpg')}}" width="200" height="123" alt=""></dt>
                 ...
                 <p class="dd_text_2">
                 <span class="left author">博主</span><span class="left sj">时间: {{ $list->created_at }}</span>
                 <span class="left fl">分类: <a href="#" title="学无止境">{{ $list->tag }}</a></span><span class="left yd"><a href="#" title="阅读全文">阅读全文</a>
                 </span>
                  <div class="clear"></div>
                 </p>
                 </dd>
